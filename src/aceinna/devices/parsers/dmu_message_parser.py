...
#                     self._current_packet = DMUPacket()
...
#         payload_parser = match_continuous_handler(data_packet.packet_type)
...
#         data = payload_parser(data_packet.payload, output_packet_config, scaling)

#         if not data:
#             APP_CONTEXT.get_logger().logger.info(
#                 'Cannot parse packet type {0}. It may caused by firmware upgrade'.format(data_packet.packet_type))
#             return
