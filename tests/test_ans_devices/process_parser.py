...
def parse_response(gdb_mi_text: str) -> Dict:
    ...
    if _GDB_MI_NOTIFY_RE.match(gdb_mi_text):
        print('parse _GDB_MI_NOTIFY_RE: ', gdb_mi_text)
        ...
        print('parse _GDB_MI_RESULT_RE: ', gdb_mi_text)
        ...
        print('parse _GDB_MI_CONSOLE_RE: ', gdb_mi_text)
        ...
        print('parse _GDB_MI_LOG_RE: ', gdb_mi_text)
        ...
        print('parse _GDB_MI_TARGET_OUTPUT_RE: ', gdb_mi_text)
...
def get_gdb_response_str(responses):
    gdb_ret = ''
