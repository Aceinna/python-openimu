...
class InceptioParse:
    ...
    def log(self, output, data):
        ...
        if output['name'] == 's1':
            ...
            buffer = buffer + format(data[12]/1000, output['payload'][12]['format']) + ","
            buffer = buffer + format(data[13]/1000, output['payload'][13]['format']) + ","
            buffer = buffer + format(data[14]/1000, output['payload'][14]['format']) + "\n"
            ...
            ff_buffer = ff_buffer + format(data[5], output['payload'][5]['format']) + ","
            ff_buffer = ff_buffer + format(data[12]/1000, output['payload'][12]['format']) + ","
            ff_buffer = ff_buffer + format(data[13]/1000, output['payload'][13]['format']) + ","
            ff_buffer = ff_buffer + format(data[14]/1000, output['payload'][14]['format']) + ","
            ...
            e_buffer = e_buffer + format(data[5], output['payload'][5]['format']) + ","
            e_buffer = e_buffer + format(data[12]/1000, output['payload'][5]['format']) + ","
            e_buffer = e_buffer + format(data[13]/1000, output['payload'][5]['format']) + ","
            e_buffer = e_buffer + format(data[14]/1000, output['payload'][5]['format']) + ","
            e_buffer = e_buffer + format(data[2], output['payload'][2]['format']) + ","
