...
def receive_args():
    ...
    parser.add_argument("-t", type=str, help="data type: openrtk or inceptio", default='openrtk')
...
if __name__ == '__main__':
    ...
    elif args.t == 'inceptio':
        json_setting = 'inceptio_packets.json'
    else:
        print('waring: can not parse such type {0}, just can be openrtk or inceptio!'.format(args.t))
        sys.exit(0)
